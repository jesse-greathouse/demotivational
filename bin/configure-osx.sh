...
if  [ "${CORRECT}" == "y" ]; then
    ...
    sed -i '' s/__GOOGLE_SEARCH_ENGINE_ID__/"${GOOGLE_SEARCH_ENGINE_ID}"/g ${RUN_SCRIPT}
    sed -i '' s/__GOOGLE_SEARCH_KEY__/"${GOOGLE_SEARCH_KEY}"/g ${RUN_SCRIPT}
    sed -i '' s/__GOOGLE_OAUTH_KEY__/"${GOOGLE_OAUTH_KEY}"/g ${RUN_SCRIPT}
    sed -i '' s/__GOOGLE_OAUTH_SECRET__/"${GOOGLE_OAUTH_SECRET}"/g ${RUN_SCRIPT}
    sed -i '' s/__FACEBOOK_OAUTH_KEY__/"${FACEBOOK_OAUTH_KEY}"/g ${RUN_SCRIPT}
    sed -i '' s/__FACEBOOK_OAUTH_SECRET__/"${FACEBOOK_OAUTH_SECRET}"/g ${RUN_SCRIPT}
